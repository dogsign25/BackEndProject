...
<body>
    ...
    <div class="page-layout">
        ...
        <div class="main-content-area">
            ...
            <div class="auth-card">
                <h2><span class="highlight">회원가입</span></h2>
                <form action="signup.do" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="phone" name="phone" placeholder="선택 사항: 010-XXXX-XXXX">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group" style="margin-top: 30px;">
                        <button type="submit" class="highlight-button">가입하기</button>
                    </div>
                </form>
                
                <p>이미 계정이 있으신가요? <a href="loginForm.do" class="highlight-link">로그인</a></p>
                <%
